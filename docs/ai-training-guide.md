...
## 7. Các bước thực hành training AI
...
### Bước 7. Cấu hình nâng cao trong tab `Cài đặt`
...
<img src="/assets/images/ai-training/09-advanced-settings.png" alt="Bước 7 - Cài đặt nâng cao" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />
...
### Bước 8. Mở `Fine-tuning`

Khi dữ liệu đã ổn, bấm nút `Fine-tuning` ở góc trên.

<img src="/assets/images/ai-training/10-open-fine-tune.png" alt="Bước 8 - Mở Fine-tuning" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

**Bạn cần làm gì ở bước này:** mở phần huấn luyện chính thức cho AI.

### Bước 9. Xem chi phí ước tính và xác nhận huấn luyện
...
<img src="/assets/images/ai-training/11-confirm-fine-tune.png" alt="Bước 9 - Xác nhận Fine-tuning" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

**Bạn cần làm gì ở bước này:** kiểm tra lại dữ liệu và xác nhận huấn luyện.

### Bước 10. Test AI sau khi hoàn tất cấu hình

Sau khi đã nhập dữ liệu và hoàn tất các bước cấu hình cần thiết, chuyển sang tab `Test AI`.
...
<img src="/assets/images/ai-training/08-test-ai-screen.png" alt="Bước 10 - Test AI" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

**Bạn cần làm gì ở bước này:** kiểm tra chất lượng câu trả lời của AI sau khi đã cấu hình xong toàn bộ flow.

## 8. Ví dụ dễ hiểu cho `OR`, `AND` và `NEXT-TAG`
...
## 9. Checklist nhanh trước khi bấm `Fine-tuning`
