...
???+ info "3. Nhóm chức năng quản lý vị trí tuyển dụng"
    ...
    ??? book "Thiết lập bài kiểm tra đầu vào (Dành cho ứng viên thực hiện trước phỏng vấn)"
        ...
        <img src="/assets/images/buddy/4-3-5/swimlane_thiet_lap_bai_kiem_tra_dau_vao_truoc_phong_van.svg" alt="" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

        <span style="display:block;text-align:center;font-weight:600;">Thiết lập bài kiểm tra đầu vào (Dành cho ứng viên thực hiện trước phỏng vấn)</span>
---
...
???+ info "5. Nhóm chức năng quản lý đào tạo (high impact lên trainer và trainee)"
    ...
    ??? book "Quản lý quy trình đào tạo"
        ...
        <img src="/assets/images/buddy/4-5-1/swimlane_quan_ly_quy_trinh_dao_tao.svg" alt="" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

        <span style="display:block;text-align:center;font-weight:600;">Quản lý quy trình đào tạo</span>
    ...
    ??? book "Quản lý đầu ra đào tạo"
        ...
        | **Vai trò** | Người phụ trách |
        | **Mô tả** | Chức năng này cho phép người phụ trách quản lý toàn bộ các tiêu chí đầu ra của quá trình training cho vị trí tuyển dụng được chọn. Các tiêu chí đầu ra sẽ được sắp xếp vào các danh mục, Hệ thống sẽ hiển thị toàn bộ các danh mục đánh giá đã từng được thiết lập cho vị trí này.<br>**Nội dung của tài liệu là các action Đánh Giá.**<br><br>Tổng quan của cấu trúc tiêu chí đầu ra như sau:<br>&emsp;- Danh mục chứa các tiêu chí đầu ra<br>&emsp;&emsp;- Danh mục nội dung trong các danh mục (**các action Đánh Giá**) |
        ...
        <img src="/assets/images/buddy/4-5-2/swimlane_quan_ly_dau_ra_dao_tao.svg" alt="" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

        <span style="display:block;text-align:center;font-weight:600;">Quản lý đầu ra đào tạo</span>
    ...
    ??? book "Quản lý tài liệu đào tạo"
        ...
        | **Vai trò** | Người phụ trách |
        | **Mô tả** | Chức năng này cho phép người phụ trách quản lý toàn bộ các bộ tài liệu của quá trình training cho vị trí tuyển dụng được chọn. Hệ thống sẽ hiển thị toàn bộ các bộ tài liệu đã từng được thiết lập cho vị trí này ở **"Danh sách tài liệu"** nằm bên phải của màn hình.<br>Người phụ trách được phép kích hoạt hoặc vô hiệu tài liệu, đồng nghĩa với việc **người được đào tạo** và **người đào tạo** sẽ không xem được bộ tài liệu bị vô hiệu bởi **người phụ trách**.<br>Bên trong tài liệu bao gồm một hoặc nhiều danh mục, trong mỗi danh mục sẽ chứa nội dung.<br>**Nội dung của tài liệu là các [action_type : instruction (`action Hướng Dẫn`), trong các action Hướng Dẫn này, người phụ trách sẽ được phép thêm mô tả và nội dung chi tiết (Văn bản (cho phép thêm định dạng văn bản), file đính kèm, URL)]**.<br><br>Tổng quan của cấu trúc tài liệu như sau:<br>&emsp;- Bộ tài liệu (hiển thị trên **Danh sách tài liệu**)<br>&emsp;&emsp;- Danh mục nội dung trong các bộ tài liệu<br>&emsp;&emsp;&emsp;- Các action Hướng Dẫn trong các danh mục nội dung tài liệu<br>&emsp;&emsp;&emsp;&emsp;- Các nội dung chi tiết của action Hướng Dẫn |
        ...
        <img src="/assets/images/buddy/4-5-3/swimlane_quan_ly_tai_lieu_dao_tao.svg" alt="" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

        <span style="display:block;text-align:center;font-weight:600;">Quản lý tài liệu đào tạo</span>
---
???+ info "6. Nhóm chức năng quản lý sau đào tạo (high impact giữa trainee và handler)"
    ...
    ??? book "Quản lý quá trình thử việc sau khi hoàn thành đào tạo"
        ...
        | **Vai trò** | Người phụ trách |
        | **Mô tả** | Chức năng này cho phép người phụ trách thiết lập các tiêu chí dành cho quá trình sau đào tạo (review ứng viên), các tiêu chí này sẽ được dùng ở phần chi tiết ứng viên.<br>Cấu trúc của danh mục tiêu chí thử việc:<br>&emsp;- Danh mục tiêu chí thử việc<br>&emsp;&emsp;- Nội dung của danh mục tiêu chí thử việc |
        ...
        <img src="/assets/images/buddy/4-6-1/swimlane_quan_ly_qua_trinh_thu_viec_sau_dao_tao.svg" alt="" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

        <span style="display:block;text-align:center;font-weight:600;">Quản lý quá trình thử việc sau khi hoàn thành đào tạo</span>
    ...
    ??? book "Quản lý các tiêu chí đánh giá sau đào tạo"
        ...
        | **Vai trò** | Người phụ trách |
        | **Mô tả** | Chức năng cho phép người phụ trách thiết lập các tiêu chí đánh giá ứng viên sau đào tạo.<br>Cấu trúc của danh mục đánh giá:<br>&emsp;- Danh mục đánh giá ứng viên<br>&emsp;&emsp;- Nội dung trong danh mục đánh giá ứng viên |
        ...
        <img src="/assets/images/buddy/4-6-2/swimlane_quan_ly_tieu_chi_danh_gia_sau_dao_tao.svg" alt="" style="display:block;margin:0 auto;max-width:1100px;width:100%;" />

        <span style="display:block;text-align:center;font-weight:600;">Quản lý các tiêu chí đánh giá sau đào tạo</span>
---
???+ info "7. "
    ### 7.  {#toc-4-7}
    #### 7.1.  {#toc-4-7-1}
